package com.edurekademo.basics;
	...
	public class EdurekaHomePage {
		...
		public EdurekaHomePage() {
			this.driver = driver;
			//this.driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		}
		
		public EdurekaHomePage(String driver2) {
		...
		public void enterEmailModal() throws IOException {
		    ...
		    title = data[1][0];
			System.out.println("shagufta1214 is " + title);
			...
			try {
				...
				try {
					...
					driver.findElement(email2).sendKeys(title + Keys.TAB);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		public void enterPasswordModal1() {
			// TODO Auto-generated method stub
